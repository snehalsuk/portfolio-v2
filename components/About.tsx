    ...
    <div className="pt-24 md:pt-32 pb-20 space-y-24 md:space-y-40">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
        <ScrollReveal direction="right" className="space-y-10">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-8xl font-display font-black tracking-tighter leading-none dark:text-white text-slate-900">
            ENGINEERING <br />{" "}
      ...
      <section className="relative space-y-12 md:space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          <ScrollReveal delay={0.1} className="h-full">
            <div className="h-full p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] dark:bg-zinc-900/60 bg-white/60 backdrop-blur-md border-2 dark:border-white/5 border-slate-100 shadow-xl space-y-6 group hover:border-blue-500/30 transition-all flex flex-col">
              ...
              <p className="dark:text-gray-400 text-slate-600 leading-relaxed flex-1">
          ...
          <ScrollReveal delay={0.2} className="h-full">
            <div className="h-full p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] dark:bg-zinc-900/60 bg-white/60 backdrop-blur-md border-2 dark:border-white/5 border-slate-100 shadow-xl space-y-6 group hover:border-purple-500/30 transition-all flex flex-col">
          ...
          <ScrollReveal delay={0.3} className="h-full">
            <div className="h-full p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] dark:bg-zinc-900/60 bg-white/60 backdrop-blur-md border-2 dark:border-white/5 border-slate-100 shadow-xl space-y-6 group hover:border-cyan-500/30 transition-all flex flex-col">
              <i className="fa-solid fa-layer-group text-4xl text-cyan-500"></i>
              <h4 className="text-2xl font-black dark:text-white text-slate-900">
                User-Centric Performance
              </h4>
              <p className="dark:text-gray-400 text-slate-600 leading-relaxed flex-1">
                Performance is not just a metric; it's a feeling. I prioritize
                optimistic UI, seamless transitions, and immediate feedback
                loops to create software that feels alive.
              </p>
            </div>
          </ScrollReveal>

          <ScrollReveal delay={0.4} className="h-full">
            <div className="h-full p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] dark:bg-zinc-900/60 bg-white/60 backdrop-blur-md border-2 dark:border-white/5 border-slate-100 shadow-xl space-y-6 group hover:border-pink-500/30 transition-all flex flex-col">
              <i className="fa-solid fa-rocket text-4xl text-pink-500"></i>
              <h4 className="text-2xl font-black dark:text-white text-slate-900">
                Future-Proof Foundations
              </h4>
              <p className="dark:text-gray-400 text-slate-600 leading-relaxed flex-1">
                I build with the assumption of change. My architectures are
                modular and decoupled, allowing for rapid iteration and the
      ...
      <section className="text-center py-12 md:py-20 relative">
        ...
        <h3 className="text-2xl sm:text-4xl md:text-6xl font-display font-medium leading-tight dark:text-white/90 text-slate-900 max-w-5xl mx-auto mb-16 px-6 italic">
