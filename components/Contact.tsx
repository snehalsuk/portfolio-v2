      ...
      <ScrollReveal direction="right">
        <div className="space-y-8 md:space-y-12">
          <div className="space-y-4 md:space-y-6">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-7xl font-display font-black tracking-tighter leading-none dark:text-white text-slate-900">
              INITIALIZE <br />{" "}
