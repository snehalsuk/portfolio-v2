    ...
    <div className="pt-24 md:pt-32 pb-12 md:pb-20 space-y-24 md:space-y-40">
      <ScrollReveal>
        <header className="max-w-4xl space-y-6 md:space-y-8">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-9xl font-display font-black tracking-tighter leading-none dark:text-white text-slate-900">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
        {SERVICES.map((service, idx) => (
          <ScrollReveal
            ...
            className="h-full"
          >
            <div className="electric-card p-6 md:p-10 lg:p-14 group hover:-translate-y-4 transition-all duration-700 dark:bg-zinc-900/40 bg-white border-2 dark:border-white/5 border-slate-200 shadow-2xl relative overflow-visible hover:shadow-blue-500/10 h-full flex flex-col">
              ...
              <div className="space-y-4 md:space-y-6 flex-1 flex flex-col">
                ...
                <p className="dark:text-gray-400 text-slate-600 text-base md:text-lg leading-relaxed font-medium mb-8 md:mb-10 flex-1">
                  {service.description}
                </p>
                ...
                <div className="pt-6 md:pt-8 border-t dark:border-white/5 border-slate-100 flex justify-between items-center mt-auto">
                  <Link
                    href="/contact"
      ...
      <section className="py-12 md:py-20 border-y dark:border-white/5 border-slate-200 text-center space-y-8 md:space-y-12">
        <ScrollReveal>
          ...
          <div className="flex flex-wrap justify-center gap-10 md:gap-24 opacity-70 dark:opacity-60 transition-all hover:opacity-100 duration-500 mt-8">
            <i className="fa-brands fa-react text-4xl md:text-5xl text-[#61DAFB]"></i>
            <i className="fa-brands fa-java text-4xl md:text-5xl text-[#007396]"></i>
            <i className="fa-brands fa-node-js text-4xl md:text-5xl text-[#339933]"></i>
            <i className="fa-brands fa-python text-4xl md:text-5xl text-[#3776AB]"></i>
            <i className="fa-brands fa-aws text-4xl md:text-5xl text-[#FF9900]"></i>
